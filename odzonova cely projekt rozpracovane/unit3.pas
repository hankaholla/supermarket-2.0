...
var
  ...
  poezia:array[1..N]of zaznam;
  sexia:array[1..N]of zaznam;
...
y:=20;
  Image1.Canvas.Fillrect(Clientrect);
  For l:=1 to N do
      Image1.Canvas.Textout(x,y*l,poezia[l].nazov);
...
begin
  ...
  y:=20;
    Image1.Canvas.Fillrect(Clientrect);
    For l:=1 to N do
        Image1.Canvas.Textout(x,y*l,sexia[l].nazov);
end;
...
{For j:=1 to N do
        ...
        if ((pole[j].kod[1])='2') and ((pole[j].kod[2])='2') then begin
                                                          inc(i);
                                                          sexia[j].nazov:=pole[i].nazov;
                                                          sexia[j].kod:=pole[i].kod;
                                                          end;
        if ((pole[j].kod[1])='3') and ((pole[j].kod[2])='3') then begin
                                                          inc(i);
                                                          poezia[j].nazov:=pole[i].nazov;
                                                          poezia[j].kod:=pole[i].kod;
                                                          end;
        end; }
